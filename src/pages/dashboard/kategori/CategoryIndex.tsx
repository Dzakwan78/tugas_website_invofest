...
const BASE_URL = "http://localhost:3000/categories"; // ← Pastikan ini sesuai dengan URL backend kamu, bisa juga menggunakan VITE_API_URL dari .env

type Category = {
  id: number;
  nama: string; // ← Menggunakan 'nama' sesuai schema.prisma
};
